/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 5ea0602755b6dab0ef3eefcbe5a07223)
// Runtime types generated with workerd@1.20251105.0 2025-05-08 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		NETWORK: "base";
		PINATA_GATEWAY_URL: "xrp.mypinata.cloud";
		CDP_API_KEY_SECRET: string;
		CDP_API_KEY_ID: string;
		PINATA_JWT: string;
		PINATA_GATEWAY_KEY: string;
		TEST_PRIVATE_KEY: string;
		TEST_RECEIVING_WALLET: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NETWORK" | "PINATA_GATEWAY_URL" | "CDP_API_KEY_SECRET" | "CDP_API_KEY_ID" | "PINATA_JWT" | "PINATA_GATEWAY_KEY" | "TEST_PRIVATE_KEY" | "TEST_RECEIVING_WALLET">> {}
}
